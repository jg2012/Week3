...
public class TeamMenuApp {
	...
	public static void main(String[] args) {
		 ...
		 * Add team member
		 * View team member
		 * Viwa ll team members
		 * Delete team members by position 
		 ...
		 */
		 ...
		 while (decision != -1) {
			 ...
			 if(decision < -1 || decision >5) {
				System.out.println("Please pikc a valid option");
			 }else if (decision == 1) {
				 showTeam(team); 
		 	 }else if (decision ==2) {
				 showTeamMember(team);
...
; 		
	...
	public static void showMenu() {
		System.out.println("Please pick an option or enter -1 to ext.");
