...
public class MoreMethods {
	...
	/*
	 * Takes an array of double and returns the average of alll elements in the array. 
	 */
	...
	/*
	 * Takes a String and an int and returns the String concentrated with itself int number of times. 
	 */
